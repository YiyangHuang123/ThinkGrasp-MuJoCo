...
class ModelFreeCollisionDetector():
    ...
    def __init__(self, scene_points, voxel_size=0.005):
        # Panda / Franka Hand approximation.
        # Keep the original GraspNet box-based collision logic unchanged;
        # only adapt the fixed finger geometry to the active Panda gripper.
        self.finger_width = 0.008
        self.finger_length = 0.056
